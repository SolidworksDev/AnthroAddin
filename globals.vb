...
Module globals
    ...
    Public Function IsDoc(ByVal strDocName As String) As Boolean
        ...
        ElseIf strFirstThreeChr = "835-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "405-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "426-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "347-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "514-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "515-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "105-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "115-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "334-" Then
            IsDoc = True
        ElseIf strFirstThreeChr = "630-" Then
            IsDoc = True

...
Public Class saveAsDXFfromAssemblyDialog
    ...
    Private Sub btnAccept_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAccept.Click
        ...
        Try
            ...
            verifyForm.VerifyDialog_AddListBox(drawingList.DrawingName, DrawingListcontrols, _
                                           ...
                                           "Save the following drawings to .dxf?",
                                           "DrawingsListBox",
                                           "Selected Drawings")
            ...
            If verifyForm.bAcceptClicked = True Then
                ...
                For i = 0 To downloadFiles.Length - 1
                    If System.IO.File.Exists(downloadFiles(i)) Then
                        invDrawingDocs(i) = invDocs.Open(downloadFiles(i), False)                        
                        drawingFileName = invDrawingDocs(i).FullDocumentName.Substring(invDrawingDocs(i).FullDocumentName.LastIndexOf("\") + 1)
                        drawingFullPath = strFileLocation + ChangeExtension(drawingFileName, ".dxf")
                        invDrawingDocs(i).SaveAs(drawingFullPath, True)
        ...
        Catch ex As Exception
            MessageBox.Show("File" + drawingFullPath + "may exist" + Chr(13) + "Please delete the file and resave")
        End Try
    ...
    Private Sub SelectUnApproved_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
